...
namespace DevExpress.Win.FunctionalTests {
	...
	public class DataFilteringTests {
		public DataFilteringTests() {
		}
		[Timeout(TestInitializer.timeOut), TestCategory("WorkOnFarm"), TestCategory("GridEditorsNavBar"), TestCategory("VS11"), TestMethod]
		public void CreateFilterViaFilterDropdownListTest() {
			using(new GridsTestInitializer()) {
				this.UIMap.SwitchToMruFilterListDemoModule();
				this.UIMap.CreateFilterViaFilterDropdownList();
				this.UIMap.CheckFilterMadeViaFilterDropdownList();
			}
		}
