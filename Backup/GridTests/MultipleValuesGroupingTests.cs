...
namespace DevExpress.Win.FunctionalTests {
	[CodedUITest]
	public class MultipleValuesGroupingTests {
		public MultipleValuesGroupingTests() {
		}
		[Timeout(TestInitializer.timeOut), TestCategory("WorkOnFarm"), TestCategory("GridEditorsNavBar"), TestCategory("VS11"), TestMethod]
		public void GroupDataByMultipleValuesTest() {
			using(new GridsTestInitializer()) {
				this.UIMap.SwitchToMultipleValuesGroupingDemoModule();
				this.UIMap.GroupDataWithMultipleValuesGrouping();
				this.UIMap.CheckGroupedDataWithMultipleValuesGrouping();
			}
		}
