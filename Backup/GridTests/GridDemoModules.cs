...
namespace DevExpress.Win.FunctionalTests.GridTests
{
	public class GridDemoModules
	{
		public class ModuleGroups
		{
			public const string UICustomization = "UI Customization";
			public const string GridViews = "Grid Views";
			public const string SummaryComputation = "Summary Computation";
		}
		public class Modules
		{
			public const string TableView = "Table View";
			public const string ColumnCustomization = "Column Customization";
			public const string DataSummariesAndAggregates = "Data Summaries and Aggregates";
		}
