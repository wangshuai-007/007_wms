...
namespace DevExpress.Win.FunctionalTests {
	...
	public class SpreadSheetTests {
		...
		public void RecalculateRowAndColumnTotalTest() {
			using(new GridsTestInitializer()) {
				this.UIMap.SwitchToSpreadSheetDemoModule();
				this.UIMap.ChangeCellsValueOnSpreadSheet();
				this.UIMap.CheckRecalculatedTotalRowAndColumnCells();
			}
		}
