...
namespace DevExpress.Win.FunctionalTests {
	[CodedUITest]
	public class SortingBySummaryTests {
		public SortingBySummaryTests() {
		}
		[Timeout(TestInitializer.timeOut), TestCategory("WorkOnFarm"), TestCategory("GridEditorsNavBar"), TestCategory("VS11"), TestMethod]
		public void AscendingSortByAveragePriceTest() {
			using(new GridsTestInitializer()) {
				this.UIMap.SwitchToSortingBySummaryDemoModule();
				this.UIMap.SortingDataByPriceAverageAscending();
				this.UIMap.CheckSortedDataByPriceAverageAscending();
			}
		}
