...
namespace DevExpress.Win.FunctionalTests {
	...
	public class CustomSummaryTests {
		public CustomSummaryTests() {
		}
		[Timeout(TestInitializer.timeOut), TestCategory("WorkOnFarm"), TestCategory("GridEditorsNavBar"), TestCategory("VS11"), TestMethod]
		public void CustomSummaryTest() {
			using(new GridsTestInitializer()) {
				this.UIMap.SwitchToCustomSummaryDemoModule();
				this.UIMap.ChangeCustomFreight();
				this.UIMap.CheckCustomSumAfterChangingCustomFreight();
			}
		}
